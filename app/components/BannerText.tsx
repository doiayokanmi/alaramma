...
function BannerText() {
    return (
        <div className="text-white bg-black/50 px-8 py-24 lg:px-32 gap-12 h-full w-full">
            <motion.div 
                initial={{ x: 2000 }} 
                animate={{ x: 0 }}
            ...
            >
                ...
                <div className="flex gap-8 font-bold justify-between lg:justify-start items-center">
